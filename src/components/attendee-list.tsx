                ...
                <table className="w-full ">
                    <thead>
                        <tr className="border-b border-white/10">
                            <th style={{ width: 48 }} className="py-3 px-4 text-sm font-semibold text-left"><input className="size-4 bg-black/20 rounded border-white/10" type="checkbox" /></th>
                            <th className="py-3 px-4 text-sm font-semibold text-left">Código</th>
                            <th className="py-3 px-4 text-sm font-semibold text-left">Participantes</th>
                            <th className="py-3 px-4 text-sm font-semibold text-left">Data inscrição</th>
                        ...
                        {Array.from({ length: 8 }).map((_, i) => {
                            return (
                                <tr key={i} className="border-b border-white/10 hover:bg-white/10">
                                    <td className="py-3 px-4 text-sm text-left text-zinc-300"><input className="size-4 bg-black/20 rounded border-white/10" type="checkbox" /></td>
                                    <td className="py-3 px-4 text-sm text-left text-zinc-300">2344</td>
                                    <td className="py-3 px-4 text-sm text-left text-zinc-300">
                                        <div className="flex flex-col gap-1">
                                            <span>João Gabriel de Matos Silva</span>
                                            <span>gabriel.122.gm85@gmail</span>
                                        </div>
                                    </td>
